...
# blupf90 solutions
trait <-
  read_table2(here::here("data/derived_data/random_regression/temp1/solutions"),
...
trait %<>%
  ...
  left_join(read_table2(here::here("data/derived_data/random_regression/temp1/renadd05.ped"),
                        col_names = FALSE) %>%
