...
matched %>%
  ...
  write_csv(here::here("data/derived_data/aireml_varcomp/an1/sanity_key.csv"),
            na = "")
...
matched %>%
  ...
  write_delim(here::here("data/derived_data/aireml_varcomp/an1/data.txt"),
              col_names = FALSE)
...
matched %>% 
  ...
  write_delim(here::here("data/derived_data/aireml_varcomp/an1/ped.an1.txt"),
              col_names = FALSE)