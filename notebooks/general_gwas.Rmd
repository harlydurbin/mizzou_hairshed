...
ggsave(filename = here::here("figures/general_gwas/fixed9_snp1101.q.transparent.png"),
       height = 3,
       width = 8,
       bg = "transparent")
```
...
```{r}
ggsave(filename = here::here("figures/general_gwas/full_q_chr5.transparent.png"),
       plot = full_q_chr5, 
       width = 8,
       height = 3,
       bg = "transparent")
