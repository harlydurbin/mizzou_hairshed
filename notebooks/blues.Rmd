...
* `fixed9`
    + `{farm_id + year + calving_season + age_group + toxic_fescue} + {mean_day_length} + {mean_apparent_high} + {farm_id}`
    + Contemporary group only
* `fixed10`
    + `{farm_id + year + calving_season + age_group + toxic_fescue} + {mean_apparent_high}`
    + Contemporary group + temp
* `fixed11`
    + `{farm_id + year + calving_season + age_group + toxic_fescue} + {mean_day_length}`
    + Contemporary group + day length
* `fixed12`
    + `{farm_id + year + calving_season + age_group + toxic_fescue} + {mean_day_length} + {mean_apparent_high}`
