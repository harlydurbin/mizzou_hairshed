...
```{r, eval=FALSE}
breeds_metasoft <- 
  read_table2(here::here("data/derived_data/metasoft/breeds/metasoft_out.breeds_corrected.var.txt"),
              col_types = cols(.default = "d", RSID = "c")) %>% 
  janitor::clean_names() %>% 
  select(-pvalues_of_studies_tab_delimitered, -mvalues_of_studies_tab_delimitered, -pvalue_be) %>% 
  left_join(read_table2(here::here("data/derived_data/metasoft/breeds/metasoft_out.breeds_corrected.var.txt"),
                        skip = 1,
