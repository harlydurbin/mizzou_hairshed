...
inb <- 
  ...
  left_join(read_table2(here::here("data/derived_data/base_varcomp/fixed9/solutions"),
              ...
              left_join(read_table2(here::here("data/derived_data/base_varcomp/fixed9/renadd02.ped"),
                                    col_names = FALSE) %>%
