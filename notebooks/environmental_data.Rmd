...
```{r, warning=FALSE, message=FALSE}
read_table2(here::here("data/derived_data/base_varcomp/fixed6/solutions"),
            skip = 1,
            col_names = c("trait", "effect", "id_renamed", "solution", "se")) %>%
...
```{r, warning=FALSE, message=FALSE}
read_table2(here::here("data/derived_data/base_varcomp/fixed5/solutions"),
            skip = 1,
            col_names = c("trait", "effect", "id_renamed", "solution", "se")) %>%
  filter(effect %in% c(5)) %>% 
...
lrt_calc(ll_null = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed6/airemlf90.fixed6.log"),
                                option = "logL"),
         ll_test = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed3/airemlf90.fixed3.log"),
                                option = "logL"))
...
lrt_calc(ll_null = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed5/airemlf90.fixed5.log"),
                                option = "logL"),
         ll_test = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed3/airemlf90.fixed3.log"),
                                option = "logL"))
...
tibble(Model = c("fixed3", "fixed6", "fixed5")) %>%
  mutate(AIC = purrr::map_dbl(.x = Model,
                              ~ parse_loglik(path = here::here(glue("data/derived_data/base_varcomp/{.x}/airemlf90.{.x}.log")),
                                             option = "AIC")),
...
```{r, warning=FALSE, message=FALSE}
read_table2(here::here("data/derived_data/base_varcomp/fixed13/solutions"),
            skip = 1,
            col_names = c("trait", "effect", "id_renamed", "solution", "se")) %>%
...
lrt_calc(ll_null = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed3/airemlf90.fixed3.log"),
                                option = "logL"),
         ll_test = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed13/airemlf90.fixed13.log"),
                                option = "logL"))
...
lrt_calc(ll_null = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed7/airemlf90.fixed7.log"),
                                option = "logL"),
         ll_test = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed8/airemlf90.fixed8.log"),
                                option = "logL"))
...
```{r, warning=FALSE, message=FALSE}
read_table2(here::here("data/derived_data/base_varcomp/fixed10/solutions"),
            skip = 1,
            col_names = c("trait", "effect", "id_renamed", "solution", "se")) %>%
...
lrt_calc(ll_null = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed9/airemlf90.fixed9.log"),
                                option = "logL"),
         ll_test = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed10/airemlf90.fixed10.log"),
                                option = "logL"))
...
```{r, warning=FALSE, message=FALSE}
read_table2(here::here("data/derived_data/base_varcomp/fixed11/solutions"),
            skip = 1,
            col_names = c("trait", "effect", "id_renamed", "solution", "se")) %>%
  filter(effect %in% c(2)) %>% 
...
lrt_calc(ll_null = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed9/airemlf90.fixed9.log"),
                                option = "logL"),
         ll_test = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed11/airemlf90.fixed11.log"),
                                option = "logL"))
...
```{r, warning=FALSE, message=FALSE}
read_table2(here::here("data/derived_data/base_varcomp/fixed12/solutions"),
            skip = 1,
            col_names = c("trait", "effect", "id_renamed", "solution", "se")) %>%
...
lrt_calc(ll_null = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed10/airemlf90.fixed10.log"),
                                option = "logL"),
         ll_test = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed12/airemlf90.fixed12.log"),
                                option = "logL"))
...
lrt_calc(ll_null = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed11/airemlf90.fixed11.log"),
                                option = "logL"),
         ll_test = parse_loglik(path = here::here("data/derived_data/base_varcomp/fixed12/airemlf90.fixed12.log"),
                                option = "logL"))
